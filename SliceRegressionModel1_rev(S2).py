...
"""This 2DCNN model with reverse configuration is to predict actual, age-corrected and residualised fluid intelligence score prediction from adjacent three axial slices"""
...
for slice_start_no in range(slice_range_start, slice_range_end, 3):
    ...
    PthModel='/datastore/sah012/CNN-3D-images-Tensorflow/super-resolution-project/ABCD-models/models1_rev/model_1_rev_'+str(slice_start)+'_'+str(slice_end)+'.hdf5'
...
df.to_csv(
    r'/datastore/sah012/CNN-3D-images-Tensorflow/super-resolution-project/ABCD-models/ABCDIQNet/results_train_val_slicemodel_1_rev.csv',
    header=True)
